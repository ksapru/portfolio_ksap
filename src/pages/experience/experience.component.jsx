...
import L_SPARK from "../../assets/img/experience/spark.png";
          ...
          <Tilt options={{ max: 25 }}>
            <Card>
              <Card.Header as="h5" className="d-flex justify-content-center flex-wrap">
                <Card.Img variant="top" className="img-resize" src='L_SPARK' alt="Spark logo" />
              </Card.Header>
              <Card.Body className="d-flex justify-content-center flex-column">
                ...
                <div>
                  <Card.Text className="text-center style">
                    ...
                    <br />
                    <strong>Technology:</strong> Vue JS, Firebase, Vuetify, Vue Material, JS, CSS, HTML
                    <br />
                    <strong>Duration:</strong> February 2021 - Present
                    <br/>
                    <strong> Description </strong>
                    <ul className="text-left">
                      <li><strong>Developed &amp; enhanced</strong> a user authentication portal for the Spark website </li>
