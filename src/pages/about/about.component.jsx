          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-2 my-details rounded">
                ...
                <br />I'd describe myself as a passionate programmer and a student at Boston University. I am a Full Stack Web Developer with experience in React.js, Redux, C, Python, Java, Node.js, and PostgreSQL as my tech stack.
                <br />
                As of 2021, I am a rising junior pursuing a degree in Computer Science.
                <br />
